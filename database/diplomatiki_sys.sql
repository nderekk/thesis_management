...
INSERT INTO `announcements` VALUES (1,9,'2025-09-05 15:19:43','ιδου μια ανακοινωση'),(2,9,'2025-09-06 17:55:09','ανακοινωση ');
...
CREATE TABLE `thesis` (
  ...
  CONSTRAINT `thesis_ibfk_221` FOREIGN KEY (`topic_id`) REFERENCES `thesis_topics` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `thesis_ibfk_222` FOREIGN KEY (`student_am`) REFERENCES `student` (`am`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `thesis_ibfk_223` FOREIGN KEY (`supervisor_am`) REFERENCES `professor` (`am`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `thesis_ibfk_224` FOREIGN KEY (`prof2_am`) REFERENCES `professor` (`am`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `thesis_ibfk_225` FOREIGN KEY (`prof3_am`) REFERENCES `professor` (`am`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `thesis` VALUES (1,1,1,1,2,3,'Completed','2025-01-15','2025-09-05','thesis1.pdf',NULL,'https://nemertes.upatras.gr/thesis1',1001,0,1),(2,2,2,2,1,3,'Active','2025-01-20',NULL,'thesis2.pdf',NULL,'https://nemertes.upatras.gr/thesis2',1002,0,0),(3,3,3,3,1,2,'Pending','2025-01-25',NULL,'thesis3.pdf',NULL,'https://nemertes.upatras.gr/thesis3',1003,0,0),(9,10,6,5,1,2,'Review','2025-09-05','2025-09-05','1757175481835-951071766.pdf','ekatharistiko2021.pdf','link-gia-nimerti.gr',1004,1,1),(25,11,4,1,2,3,'Completed','2025-02-10','2025-09-06','thesis4.pdf',NULL,'https://nemertes.upatras.gr/thesis4',1004,0,1),(26,12,5,2,1,3,'Completed','2025-02-12','2025-09-06','thesis5.pdf',NULL,'https://nemertes.upatras.gr/thesis5',1005,0,1),(27,13,7,3,1,2,'Completed','2025-02-15','2025-09-06','thesis7.pdf',NULL,'https://nemertes.upatras.gr/thesis7',1007,0,1),(28,14,8,4,2,5,'Active','2025-02-20',NULL,'thesis8.pdf',NULL,'https://nemertes.upatras.gr/thesis8',1008,0,0),(29,15,9,5,3,4,'Cancelled','2025-02-25',NULL,'thesis9.pdf',NULL,'https://nemertes.upatras.gr/thesis9',1009,0,0);
...
CREATE TABLE `thesis_comments` (
  ...
  KEY `prof_am` (`prof_am`),
  KEY `thesis_id` (`thesis_id`),
  CONSTRAINT `thesis_comments_ibfk_89` FOREIGN KEY (`prof_am`) REFERENCES `professor` (`am`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `thesis_comments_ibfk_90` FOREIGN KEY (`thesis_id`) REFERENCES `thesis` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `thesis_grade` (
  ...
  KEY `prof2am` (`prof2am`),
  KEY `prof3am` (`prof3am`),
  CONSTRAINT `thesis_grade_ibfk_177` FOREIGN KEY (`thesis_id`) REFERENCES `thesis` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `thesis_grade_ibfk_178` FOREIGN KEY (`prof1am`) REFERENCES `professor` (`am`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `thesis_grade_ibfk_179` FOREIGN KEY (`prof2am`) REFERENCES `professor` (`am`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `thesis_grade_ibfk_180` FOREIGN KEY (`prof3am`) REFERENCES `professor` (`am`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `thesis_grade` VALUES (1,1,9.00,1,10.00,10.00,10.00,10.00,2,9.00,9.00,9.00,9.00,3,8.00,8.00,8.00,8.00),(2,9,8.00,5,9.00,9.00,9.00,9.00,1,7.00,7.00,7.00,7.00,2,8.00,8.00,8.00,8.00),(6,25,8.00,1,9.00,9.00,9.00,9.00,2,8.00,8.00,8.00,8.00,3,9.00,9.00,9.00,9.00),(7,26,9.00,1,10.00,10.00,10.00,9.00,2,9.00,9.00,9.00,9.00,3,8.00,8.00,8.00,8.00),(8,27,7.00,1,7.00,7.00,7.00,7.00,2,8.00,8.00,8.00,8.00,3,7.00,7.00,7.00,7.00);
...
INSERT INTO `thesis_logs` VALUES (1,9,'2025-09-05 14:35:44','Pending','Active'),(2,9,'2025-09-05 14:41:11','Active','Review'),(3,9,'2025-09-05 15:28:18','Review','Completed');
...
CREATE TABLE `thesis_topics` (
  ...
  CONSTRAINT `thesis_topics_ibfk_89` FOREIGN KEY (`prof_am`) REFERENCES `professor` (`am`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `thesis_topics_ibfk_90` FOREIGN KEY (`student_am`) REFERENCES `student` (`am`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `trimelis_requests` (
  ...
  KEY `thesis_id` (`thesis_id`),
  KEY `prof_am` (`prof_am`),
  CONSTRAINT `trimelis_requests_ibfk_87` FOREIGN KEY (`thesis_id`) REFERENCES `thesis` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `trimelis_requests_ibfk_88` FOREIGN KEY (`prof_am`) REFERENCES `professor` (`am`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-09-06 21:15:06
